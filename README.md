...
The following figure explains the terms used in HDF5, such as file data-space, memory-space, file-hyperslab, and memory-hyperslab. The data-spaces only contain the meta-data such as size of the array, data-type, and the information of the associated hyperslab. Hyperslab is defined by the start index and the count in each direction.
<p align="center">
