...
WRITE(error_unit,*) "mod_h5_utility/create/{"
            ...
            DO i=1,n_dim
                ...
                IF(PRESENT(mem_size) .AND. PRESENT(mem_start)) THEN
                    ...
                    mem_stride(i)     = 1
                    mem_block(i)      = self%count(i) !1
                    self%mem_count(i) = 1 !self%count(i) ! Should be equal to self%count(i) element-wise.
                ELSE
        ...
        SUBROUTINE append_real64_2d(self, array, data_index)
            ...
            WRITE(error_unit,*) 'DEBUG append_real64_2d: ', self%error
            IF(debug) WRITE(error_unit,*) "mod_h5_utility/append_real64_2d/}"
        ...
        SUBROUTINE destructor(self)
            ...
            write(error_unit,*) ' DEBUG destructor: 01', n_h5_dataset_type_objects
            ...
            write(error_unit,*) ' DEBUG destructor: 02 ', hdf5_initialized, ' ', n_h5_dataset_type_objects
