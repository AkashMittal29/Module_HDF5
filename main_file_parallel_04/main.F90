...
MODULE data
    ...
    CONTAINS
        ...
        SUBROUTINE get_indices_for_box(x_grid_1d_, y_grid_1d_, x_box, y_box, is_box_present, &
            ...
            REAL(kind=8), DIMENSION(:),INTENT(IN) :: x_grid_1d_, y_grid_1d_, x_box, y_box
...
PROGRAM main
    ...
    REAL(kind=8), PARAMETER :: eps = 1e-15
    ...
    REAL(kind=8) :: x_box(2) = (/0.4_real-eps, 2.2_real+eps/), y_box(2) = (/0.3_real-eps, 0.9_real+eps/) ! the box coordinates within which data is to be written.
